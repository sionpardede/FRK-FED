<?php echo form_open('comment/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="comment_status" class="form-control">
				...
				{
					$selected = ($value == $this->input->post('comment_status')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="comment_subject" value="<?php echo $this->input->post('comment_subject'); ?>" class="form-control" id="comment_subject" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="comment_text" class="form-control" id="comment_text"><?php echo $this->input->post('comment_text'); ?></textarea>
