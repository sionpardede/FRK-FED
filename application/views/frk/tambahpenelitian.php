        ...
        <div class="col-md-7">
            <div class="card mb-5">
                <div class="card-header">
                    Form Tambah Data Penelitian
                </div>
                <div class="card-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <label for="penelitian" class="col-form-label">Nama Kegiatan Penelitian</label>
                            <input type="text" name="penelitian" class="form-control" id="penelitian">
                        ...
                        <button type="submit" name="tambahPenelitian" class="btn btn-primary float-right">Tambah Data</button>
                    </form>
                </div>
            </div>
